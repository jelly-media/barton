	...
	class Modula {
		...
		public function register_links( $links, $file ) {
			...
			if ( $file == $base ) {
				...
				$links[] = '<a href="https://twitter.com/MachoThemez" title="@GreenTreeLabs on Twitter">Twitter</a>';
				$links[] = '<a href="https://www.facebook.com/MachoThemes" title="GreenTreeLabs on Facebook">Facebook</a>';
			}
		...
		public function add_gallery_scripts() {
			...
			wp_register_script( 'magnific_script', plugins_url() . '/modula/lightbox/magnific/script.js', array( 'jquery' ) );
			wp_register_script( 'prettyphoto_script', plugins_url() . '/modula/lightbox/prettyphoto/script.js', array( 'jquery' ) );
			wp_register_script( 'fancybox_script', plugins_url() . '/modula/lightbox/fancybox/script.js', array( 'jquery' ) );
			wp_register_script( 'swipebox_script', plugins_url() . '/modula/lightbox/swipebox/script.js', array( 'jquery' ) );
			wp_register_script( 'lightbox2_script', plugins_url() . '/modula/lightbox/lightbox2/js/script.js', array( 'jquery' ) );
			wp_register_script( 'lightgallery_script', plugins_url() . '/modula/lightbox/lightgallery/script.js', array( 'jquery' ) );

			wp_register_style( 'magnific_stylesheet', plugins_url() . '/modula/lightbox/magnific/style.css' );
			wp_register_style( 'prettyphoto_stylesheet', plugins_url() . '/modula/lightbox/prettyphoto/style.css' );
			wp_register_style( 'fancybox_stylesheet', plugins_url() . '/modula/lightbox/fancybox/style.css' );
			wp_register_style( 'swipebox_stylesheet', plugins_url() . '/modula/lightbox/swipebox/style.css' );
			wp_register_style( 'lightbox2_stylesheet', plugins_url() . '/modula/lightbox/lightbox2/css/style.css' );
