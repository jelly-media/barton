...
$modula_options = get_option( 'Modula_options' );
	...
	<form action="#" method="post">
		...
		<fieldset data-step="2" data-branch="images">
			<div class="field">
				...
				<select name="ftg_wp_field_title">
			...
			<div class="field">
				...
				<select name="ftg_wp_field_caption">
			...
			<div class="field">
				<h5><?php _e( 'Hover effect:', 'modula' ) ?></h5>
				<select name="tg_hoverEffect" class="select-effect">
					<?php foreach ( $this->hoverEffects as $effect ) : ?>
						<option <?php echo $effect->code == 'pufrobo' ? 'selected' : '' ?> value="<?php echo esc_attr( $effect->code ); ?>"><?php echo esc_html( $effect->name ); ?></option>
					<?php endforeach ?>
				</select>
				<label><a href="http://modula.greentreelabs.net/demo/effects/appear/" target="_blank"><?php echo esc_html__( 'Look at all hover effects demos', 'modula-gallery' ) ?></a></label>
			</div>
		</fieldset>
		<fieldset data-step="3" data-save="true">
			...
			<div class="field select-images">
				<a class="waves-effect waves-light btn add-images">
					<i class="fa fa-plus left"></i> <?php echo esc_html__( 'Add images', 'modula-gallery' ) ?></a> <br>
				<label><?php echo esc_html__( 'You can add images now or later.', 'modula-gallery' ) ?></label>
