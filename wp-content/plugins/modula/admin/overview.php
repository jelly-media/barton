...
<div class="bd">
			...
			<div class="col s12 m6 l4">
				<div class="card-panel light-green lighten-4">
					...
					<p>
						...
						<a href="?page=modula-pro-add"><?php echo esc_html__( 'here', 'modula-gallery' ) ?></a>. </p>
				</div>
			</div>
		</div>
	<?php else : ?>
		...
		<div id="gallery-list" class="row">
			<?php foreach ( $galleries as $gallery ) :
				...
				<div class="col s12 m6 l3">
					<div class="card <?php print count( $images ) ? "with-image" : "" ?>" id="gallery-<?php echo esc_attr( $gid ); ?>" data-gid="<?php echo esc_attr( $gid ); ?>">

						<div class="data" style="background-image:<?php echo esc_attr( $bg ); ?>">
							<div class="card-content white-text">
								<span class="card-title"><?php echo esc_html( $gallery->name ); ?></span>
								<?php if ( strlen( $gallery->description ) ) : ?>
									<p><?php echo esc_html( $gallery->description ); ?></p>
								<?php endif ?>
							</div>
							<div class="card-action darken-4">
								<a href="#" data-tooltip="Show shortcode" data-position="top" data-delay="10" class="tooltipped waves-effect show-shortcode" data-gid="<?php echo esc_attr( $gid ); ?>"><i class="mdi-action-settings-ethernet"></i></a>
								<a href="?page=modula-pro-edit&galleryId=<?php echo absint( $gid ); ?>" data-tooltip="Edit gallery" data-position="top" data-delay="10" class="tooltipped waves-effect waves"><i class="mdi-editor-mode-edit"></i></a>
								<a data-tooltip="Clone gallery" data-position="top" data-delay="10" class="tooltipped waves-effect waves clone-gallery" data-gid="<?php echo esc_attr( $gid ); ?>"><i class="mdi-content-content-copy"></i></a>

								<a data-tooltip="Delete gallery" datacolor="red" data-position="top" data-delay="10" class="tooltipped waves-effect waves delete-gallery" data-gid="<?php echo esc_attr( $gid ); ?>"><i class="mdi-action-delete"></i></a>
							</div>
						</div>
					</div>
				</div>
	...
	<div class="fixed-action-btn" style="bottom: 15px; right: 24px;">
		<a href="?page=add-modula" class="btn-floating btn-large green"> <i class="large mdi-content-add"></i> </a>
	</div>
</div>
...
<div id="delete-gallery-modal" class="modal">
	<div class="modal-content">
		...
		<p><?php echo esc_html__( 'Do you really want to delete the gallery', 'modula-gallery' ) ?> <span></span> ?</p>
	</div>
...
<script>
  (function( $ ) {
    ...
    $( '.card .card-content' ).click( function() {
      ...
      location.href = '?page=modula-pro-edit&galleryId=' + id;
    } );
