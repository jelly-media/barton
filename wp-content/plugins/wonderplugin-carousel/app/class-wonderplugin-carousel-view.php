...
class WonderPlugin_Carousel_View {
	...
	function show_upgrade_to_commercial() {
		...
		<ul class="wonderplugin-feature-list">
			...
			<li><a href="http://www.wonderplugin.com/wordpress-carousel/order/" target="_blank">Upgrade to Commercial Version</a></li>
		</ul>
		<?php
	}
				...
				<div class="welcome-panel-column-container">
					...
					<div class="welcome-panel-column welcome-panel-last">
						...
						<ul>
							...
							<li><a href="http://www.wonderplugin.com/wordpress-carousel/order/" target="_blank" class="welcome-icon welcome-view-site">Upgrade to Commercial Version</a></li>
							<?php } ?>
						</ul>
					</div>
				</div>
	...
	function print_edit_settings() {
		...
		$doublebackslash = $settings['doublebackslash'];
		?>
		...
		<tr>
			...
			<p><label><input name='doublebackslash' type='checkbox' id='doublebackslash' <?php echo ($doublebackslash == 1) ? 'checked' : ''; ?> /> Double backslashes in JavaScript before submit</label></p>
			</td>
		</tr>
	...
	function print_register() {
		...
		function validateLicenseForm() {
			...
			if ($.trim($("#wonderplugin-carousel-key").val()).length <= 0)
			{
		...
		?> <div style="padding-left:10px;padding-top:12px;"> <?php
			if (empty($key)) { ?>
				...
				<tr>
					...
					<td><input name="wonderplugin-carousel-key" type="text" id="wonderplugin-carousel-key" value="" class="regular-text" /> <input type="submit" name="save-carousel-license" id="save-carousel-license" class="button button-primary" value="Register"  />
					</td>
				</tr>
				<tr>
					<th></th>
	...
	function print_item()
	{
		...
		<?php 
		if (WONDERPLUGIN_CAROUSEL_VERSION_TYPE !== "C")
			echo '<div class="updated"><p style="text-align:center;">To remove the Free Version watermark, please <a href="https://www.wonderplugin.com/wordpress-carousel/order/" target="_blank">Upgrade to Commercial Version</a>.</p></div>';

		echo $this->controller->generate_body_code( $_REQUEST['itemid'], null, true, null, null ); 
		?>	 
