						...
						<div class="wonderplugin-gallery-options-tab wonderplugin-gallery-options-tab-selected">
							<table class="wonderplugin-form-table-noborder">
								...
								<tr>
									...
									<br /><label><input name='wonderplugin-gallery-reloadonvideoend' type='checkbox' id='wonderplugin-gallery-reloadonvideoend' value='' /> Reload and display the poster image when the current video ends</label>
									<br /><label><input name='wonderplugin-gallery-loadnextonvideoend' type='checkbox' id='wonderplugin-gallery-loadnextonvideoend' value='' /> Load the next video and stop when the current video ends</label>
									<br /><label><input name='wonderplugin-gallery-donotuseposter' type='checkbox' id='wonderplugin-gallery-donotuseposter' value='' /> Do not use poster image for videos</label>
									<br /><label>Default HTML5 video volume (0 to 1): <input name='wonderplugin-gallery-defaultvideovolume' type='number' id='wonderplugin-gallery-defaultvideovolume' min="0" max="1" step="0.1" value="1" class="small-text" /></label>
									</td>
								</tr>
								<tr>
									<th>Responsive</th>
