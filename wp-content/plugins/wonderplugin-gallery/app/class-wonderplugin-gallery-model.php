...
class WonderPlugin_Gallery_Model {
	...
	function generate_body_code($id, $data_attributes, $has_wrapper) {
				...
				{					
					...
					else
					{
						...
						else if ($slide->type == 1)
						{
							...
							if (isset($slide->image) && $slide->image && (!isset($data->donotuseposter) || (strtolower($data->donotuseposter) === 'false')))
