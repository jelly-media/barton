...
define('WONDERPLUGIN_GALLERY_VERSION', '11.4');
...
define('WONDERPLUGIN_GALLERY_PLUGIN_VERSION', '11.4');
...
class WonderPlugin_Gallery_Plugin {
	...
	function register_menu()
	{
		...
		$menu = add_submenu_page(
				'wonderplugin_gallery_overview',
				__('Import/Export', 'wonderplugin_gallery'),
				__('Import/Export', 'wonderplugin_gallery'),
				'manage_options',
	...
	function shortcode_handler($atts) {
		...
		return $this->wonderplugin_gallery_controller->generate_body_code( $atts['id'], $attributes, false);
	}
