...
class WonderPlugin_Popup_Creator {
	...
	function render( $id, $config, $options ) {
		...
		<div style="display:none;">
			...
			?>
			<div id="wonderplugin-popup-pagelist" style="display:none;"><?php echo json_encode($pagelist); ?></div>
			<?php 
				$cats = get_categories();
				$catlist = array();
				foreach ( $cats as $cat )
		...
		<div class="wonderplugin-left-menu">
			<ul class="wonderplugin-tab-buttons wonderplugin-tab-buttons-vertical" id="wp-vertical-toolbar" data-panelsid="wonderplugin-popup-panels">
				...
				<li class="wonderplugin-tab-button wonderplugin-tab-button-vertical"><span class="wonderplugin-icon-count">4</span><?php _e( 'Action', 'wonderplugin_popup' ); ?></li>
				<li class="wonderplugin-tab-button wonderplugin-tab-button-vertical"><span class="wonderplugin-icon-count">5</span><?php _e( 'Analytics', 'wonderplugin_popup' ); ?></li>
			...
			<ul class="wonderplugin-tabs wonderplugin-tabs-vertical"  id="wonderplugin-popup-panels">
						...
						<ul class="wonderplugin-tabs wonderplugin-tabs-horizontal" id="wonderplugin-popup-design-panels">
							<li class="wonderplugin-tab wonderplugin-tab-horizontal wonderplugin-tab-selected">
								...
								<table class="wonderplugin-form-table-noborder">
									...
									<tr style="display:<?php echo ($config['type'] == 'lightbox') ? 'table-row' : 'none'; ?>;">
							...
							<li class="wonderplugin-tab wonderplugin-tab-horizontal">
								...
								<table class="wonderplugin-form-table-noborder">
									...
									<tr id="wonderplugin-popup-design-video">
										<th>Video iFrame URL:</th>
										<td></td><td></td>
										<td><input name="wonderplugin-popup-video" type="text" id="wonderplugin-popup-video" value="<?php echo $config['video']; ?>" class="wonderplugin-popup-contentoption wonderplugin-popup-option large-text" />
										<p><label><input type="checkbox" name="wonderplugin-popup-videoautoplay" id="wonderplugin-popup-videoautoplay" value="1" <?php if (isset($config['videoautoplay']) && $config['videoautoplay']) echo 'checked'; ?> class="wonderplugin-popup-option"> Auto play video (Only support YouTube and Vimeo, do not work on mobile and tablets)</label></p>
										<?php if ($config['type'] != 'embed') { ?>
										<p><label><input type="checkbox" name="wonderplugin-popup-videoautoclose" id="wonderplugin-popup-videoautoclose" value="1" <?php if (isset($config['videoautoclose']) && $config['videoautoclose']) echo 'checked'; ?> class="wonderplugin-popup-option"> Auto close the popup after the video has finished (Only support YouTube and Vimeo)</label></p>
										<?php } ?>
										<p><a href="https://www.wonderplugin.com/wonderplugin-popup/youtube-lightbox-popup/" target="_blank">Tutorial: How to play YouTube, Vimeo and other iFrame videos</a></p>
										</td>
									</tr>
							...
							<li class="wonderplugin-tab wonderplugin-tab-horizontal" id="wonderplugin-tab-form">
								...
								<table class="wonderplugin-form-table-noborder">
									...
									<tr id="wonderplugin-popup-design-email">
										<th>Email:</th>
									...
									<tr id="wonderplugin-popup-design-name">
										<th>Name:</th>
									...
									<tr id="wonderplugin-popup-design-firstname">
										<th>First name:</th>
									...
									<tr id="wonderplugin-popup-design-lastname">
										<th>Last name:</th>
									...
									<tr id="wonderplugin-popup-design-phone">
										<th>Phone:</th>
									...
									<tr id="wonderplugin-popup-design-company">
										<th>Company name:</th>
									...
									<tr id="wonderplugin-popup-design-zip">
										<th>Zip code:</th>
									...
									<tr id="wonderplugin-popup-design-message">
										<th>Message:</th>
				...
				<li class="wonderplugin-tab wonderplugin-tab-vertical">
					...
					<ul class="wonderplugin-tab-buttons wonderplugin-tab-buttons-horizontal" id="wp-rules-toolbar" data-panelsid="wonderplugin-popup-display-panels">
						...
						<li class="wonderplugin-tab-button wonderplugin-tab-button-horizontal"><span class="dashicons dashicons-smartphone" style="margin-right:8px;"></span><?php _e( 'Page and Device Rules', 'wonderplugin_popup' ); ?></li>
						<?php } ?>
					...
					<ul class="wonderplugin-tabs wonderplugin-tabs-horizontal" id="wonderplugin-popup-display-panels">
						...
						<li class="wonderplugin-tab wonderplugin-tab-horizontal <?php if ($config['type'] == 'embed') echo 'wonderplugin-tab-selected'; ?>">
							...
							<h4><label><input type="checkbox" name="wonderplugin-popup-enableretarget" value="1" <?php if ($config['enableretarget']) echo 'checked'; ?>> Enable regargeting rules </label></h4>
				...
				<li class="wonderplugin-tab wonderplugin-tab-vertical">
					...
					<select name="wonderplugin-popup-subscription" id="wonderplugin-popup-subscription" class="wonderplugin-popup-option">
						...
						<option value="getresponse" <?php if ($config['subscription'] == "getresponse") echo "selected"; ?>>GetResponse</option>
					...
					<div class="wonderplugin-popup-subscription-options" id="wonderplugin-popup-subscription-mailchimp">
						...
						<input name='wonderplugin-popup-mailchimpapikeysave' id='wonderplugin-popup-mailchimpapikeysave' class="button button-primary" type="submit" value="Retrieve Campaign List by Key"></input></td>
						</td></tr>
						...
						if ( !empty($config["mailchimplists"]) )
						{
							...
							if (!empty($lists)){
						?>	
						<tr><td>Select a MailChimp list:</td><td>
						...
						<tr id="mailchimplistgroups" style="display:none;"><td style="vertical-align:top;">List group:</td><td><div id="mailchimplistgroupscontent"></div></td></tr>
						<?php 
							}
						}
						?>
					...
					<div class="wonderplugin-popup-subscription-options" id="wonderplugin-popup-subscription-getresponse">
						...
						<tr><td>Your GetResponse API key:
					...
					<h3>Save to the WordPress Database of this Website</h3>
					
					<p><label><input type="checkbox" name="wonderplugin-popup-savetolocal" id="wonderplugin-popup-savetolocal" value="1" <?php if ($config['savetolocal']) echo 'checked'; ?> class="wonderplugin-popup-option"> Save to the WordPress database of this website</label></p>
					<p style="font-style:italic;"> * You can access the saved data in the plugin menu WonderPlugin Popup -> WordPress Database)</p>
					...
					<p><label>Email Subject: </label><input name='wonderplugin-popup-emailsubject' type='text' id='wonderplugin-popup-emailsubject' value='<?php if (isset($config['emailsubject'])) echo $config['emailsubject']; ?>' style='width:50em;' /></p>
					<p style="font-style:italic;"> * You can configure the sending from name, email address and SMTP server in the plugin menu WonderPlugin Popup -> Settings</p>
				...
				<li class="wonderplugin-tab wonderplugin-tab-vertical">
					...
					<td><div style="margin:24px auto;"><label><input type="checkbox" id="wonderplugin-popup-uniquevideoiframeid" name="wonderplugin-popup-uniquevideoiframeid" value="1" <?php if ($config['uniquevideoiframeid']) echo 'checked'; ?>>Use a unique ID for video iframe</label></div></td>
					</tr>
