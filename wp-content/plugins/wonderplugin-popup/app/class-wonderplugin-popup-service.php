...
class WonderPlugin_Popup_Service {
	...
	function subscribe($post) {
		...
		if ($options['savetolocal'] || ($options['emailnotify'] && is_email($options['emailto'])))
		{
			unset($data['g-recaptcha-response']);
			$ret = $this->controller->save_to_local_and_email_notify($id, $data, $options['savetolocal'], $options['emailnotify'], $options['emailto'], $options['emailsubject']);
